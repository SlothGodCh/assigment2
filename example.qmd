...
##5. Create a Merge Conflict and push fix
...
We use -d to safely deletes the branch only if merged. Use -D to force-delete if necessary (e.g., unmerged changes).
...
9.  Undo a Commit (Without Losing Changes)
